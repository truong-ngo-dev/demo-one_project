...
@Getter
public class OccupancyAgreementTerminatedEvent extends AbstractDomainEvent implements DomainEvent {
    ...
    public OccupancyAgreementTerminatedEvent(OccupancyAgreementId agreementId, String partyId,
