...
@Getter
public class EmploymentCreatedEvent extends AbstractDomainEvent implements DomainEvent {

    private final String employmentId;
    private final String personId;
    private final String orgId;

    public EmploymentCreatedEvent(EmploymentId employmentId, PartyId personId, PartyId orgId) {
