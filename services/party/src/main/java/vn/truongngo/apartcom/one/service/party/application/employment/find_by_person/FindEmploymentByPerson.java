package vn.truongngo.apartcom.one.service.party.application.employment.find_by_person;
...
public class FindEmploymentByPerson {

    public record Query(String personId, EmploymentStatus status) {
        public Query {
    ...
    public static class Handler implements QueryHandler<Query, List<EmploymentView>> {
        ...
        public List<EmploymentView> handle(Query query) {
            List<Employment> list = employmentRepository.findByEmployeeId(PartyId.of(query.personId()));
