package vn.truongngo.apartcom.one.service.admin.application.policy_set.delete_preview;
...
public class GetPolicySetDeletePreview {
    ...
    public static class Handler implements QueryHandler<Query, Result> {
        ...
        public Result handle(Query query) {
            ...
            policySetRepository.findById(id).orElseThrow(PolicySetException::policySetNotFound);
