...
import vn.truongngo.apartcom.one.service.admin.application.resource.add_action.AddActionToResource;
import vn.truongngo.apartcom.one.service.admin.application.resource.create_resource.CreateResourceDefinition;
import vn.truongngo.apartcom.one.service.admin.application.resource.delete_resource.DeleteResourceDefinition;
import vn.truongngo.apartcom.one.service.admin.application.resource.remove_action.RemoveActionFromResource;
import vn.truongngo.apartcom.one.service.admin.application.resource.update_action.UpdateActionDefinition;
import vn.truongngo.apartcom.one.service.admin.application.resource.update_resource.UpdateResourceDefinition;
import vn.truongngo.apartcom.one.service.admin.application.resource.get_resource.GetResourceDefinition;
import vn.truongngo.apartcom.one.service.admin.application.resource.list_resources.ListResourceDefinitions;
