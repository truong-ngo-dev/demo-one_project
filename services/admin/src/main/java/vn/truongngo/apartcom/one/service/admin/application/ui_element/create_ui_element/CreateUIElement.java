package vn.truongngo.apartcom.one.service.admin.application.ui_element.create_ui_element;
    ...
    public static class Handler implements CommandHandler<Command, Result> {
        ...
        public Result handle(Command command) {
            if (uiElementRepository.existsByElementId(command.elementId())) {
                throw UIElementException.uiElementIdDuplicate();
            }
            ...
            eventDispatcher.dispatch(new AbacAuditLogEvent(
                    AuditEntityType.UI_ELEMENT, saved.getId().getValue(), saved.getElementId(),
